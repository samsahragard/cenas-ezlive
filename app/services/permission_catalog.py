...
# ---- Roles (blessed by Sam #1681: split corporate_driver from driver, add cashier,
# keep prep_manager). 'driver' (ezCater delivery) is LOCKED/separate - not a template here. ----
ROLES = [
...
MGR_UP      = ["partner", "corporate", "corporate_chef", "gm", "km",
               "assistant_km", "foh_manager", "prep_manager"]                  # manager-level+
...
CATALOG = [
 ...
 {"id": 2, "key": "time", "name": "Time & Attendance", "perms": [
   ...
   {"id":"2.6","key":"schedule.configure","label":"Configure Schedules","status":"reserved","default_roles":GM_UP,
 ...
 {"id": 7, "key": "employees", "name": "Employee Management", "perms": [
   ...
   {"id":"7.2","key":"emp.add","label":"Add New Employees","status":"live","default_roles":GM_UP,
