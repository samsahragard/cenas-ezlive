...
EXEMPT_PREFIXES = (
    ...
    "/employee/shift-marketplace",  # Schedules V2 B9: ck's PAGE GET /employee/shift-marketplace (HTML; self-guards employee_id -> 302 /employee/login) + its /list data. ckai EXEMPTs the sibling DATA prefixes /employee/shift-offers + /employee/shift-swaps separately (each self-guards -> 401 JSON). dedupe with ckai if duplicated at merge.
