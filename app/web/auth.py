...
EXEMPT_PREFIXES = (
    ...
    "/employee/availability",    # Schedules V2 B8: one prefix covers ck's PAGE GET /employee/availability (HTML; self-guards employee_id -> 302 /employee/login) AND ckai's DATA /employee/availability/list + /recurring + /block (each self-guards -> 401 JSON). Same as /employee/time-off. NOTE: ckai's B8 backend likely EXEMPTs this too - dedupe at merge.
