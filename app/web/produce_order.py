...
PRODUCE_PHOTO_SLUGS = {
    ...
    "Tomates Roma":       "tomato-roma",
    "Onion Yel. Jumbo":   "onion-yellow",
    "Onion Yellow":       "onion-yellow",
    "Onion Yel.":         "onion-yellow",
    "Cilantro":           "cilantro",
    "Cilantro (Bulk)":    "cilantro",
    # ---- Phase B (full-catalog pass, dck — 23 new photos from refs 105/106) ----
    # Each entry matched by photo content (not source label) per cena #2670 —
    # source catalog has known label/photo mismatches in some middle rows.
    "Cabbage Grn.":       "cabbage-green",
    "Cabbage Green":      "cabbage-green",
    "Cabbage Red Ctn":    "cabbage-red",
    "Cabbage Red":        "cabbage-red",
    "Carrots Jumbo":      "carrots",
    "Carrots":            "carrots",
    "Cucumber":           "cucumber",
    "Cucumbers":          "cucumber",
    "Ginger":             "ginger",
    "Lett. Iceberg":      "lettuce-iceberg",
    "Lettuce Iceberg":    "lettuce-iceberg",
    "Lett. Romaine":      "lettuce-romaine",
    ...
    "Mangos":             "mangos",
    "Mango":              "mangos",
    "Mushroom Gen.":      "mushroom",
    "Mushroom":           "mushroom",
    "Mushroom Cello":     "mushroom-cello",
    "Onion White Jbo":    "onion-white",
    "Onion White":        "onion-white",
    "Onion Red Jbo":      "onion-red",
    "Onion Red":          "onion-red",
    "Oranges Calif.":     "oranges",
    "Oranges Cal.":       "oranges",
    "Oranges":            "oranges",
    "Pepper Green Bell":  "pepper-green-bell",
    "Pepper Jalapeno":    "pepper-jalapeno",
    "Pepper Poblano":     "pepper-poblano",
    "Pepper Serrano":     "pepper-serrano",
    "Potatoes A Red":     "potatoes-red",
    "Potatoes B Red":     "potatoes-red",
    "Potatoes Red":       "potatoes-red",
    "Squash Mexican":     "squash-mexican",
    "Squash Zuchinni":    "squash-zucchini",
    "Squash Zucchini":    "squash-zucchini",
    "Tomatillo Pelon":    "tomatillo",
    "Tomatillo":          "tomatillo",
