# C.E.N.A. supervisor daily mine - 2026-06-12

Turns in window (24h): 0
Grades: {}
Flag reasons: {}
Routes: {}
...
- UNMAPPED: appdb.processing_jobs (435 rows)
- UNMAPPED: appdb.driver_logs (9 rows)
- UNMAPPED: appdb.order_items (1171 rows)
- UNMAPPED: appdb.processing_orders (435 rows)
- UNMAPPED: appdb.prep_breakdowns (1171 rows)
- UNMAPPED: appdb.developer_chat (108 rows)
...
- UNMAPPED: appdb.sales_insights (35 rows)
- UNMAPPED: appdb.sam_chat_sessions (25 rows)
- UNMAPPED: appdb.sam_chat_messages (2791 rows)
- UNMAPPED: appdb.ambient_signal_runs (3292 rows)
...
- UNMAPPED: appdb.driver_assignment_jobs (475 rows)
- UNMAPPED: appdb.docck_agents (3 rows)
- UNMAPPED: appdb.docck_heartbeats (82547 rows)
- UNMAPPED: appdb.docck_restart_sequences (65 rows)
- UNMAPPED: appdb.docck_alerts_sent (607 rows)
- UNMAPPED: appdb.docck_circuit_breaker (3 rows)
- UNMAPPED: appdb.docck_restart_steps (182 rows)
