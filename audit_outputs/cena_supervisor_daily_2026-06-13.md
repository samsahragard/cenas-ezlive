# C.E.N.A. supervisor daily mine - 2026-06-13
...
- UNMAPPED: appdb.developer_chat (113 rows)
...
- UNMAPPED: appdb.sales_insights (33 rows)
- UNMAPPED: appdb.sam_chat_sessions (25 rows)
- UNMAPPED: appdb.sam_chat_messages (2792 rows)
- UNMAPPED: appdb.ambient_signals (1 rows)
- UNMAPPED: appdb.ambient_signal_runs (3370 rows)
...
- UNMAPPED: appdb.docck_heartbeats (87848 rows)
...
- UNMAPPED: appdb.perf_shift_cache (1813 rows)
